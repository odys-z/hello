...
from query_strings import fieldeclpointer_funcdecl_fdretdecl, field_id_isfunc
...
class MetaClass(Anson):
    # You understand me and add the fields
    pass

def extract_enum() -> MetaEnum:
    pass

def extract_class() -> MetaClass:
    pass

def parse_tree(tree: Tree, found_enums, found_classes) :
    pass
