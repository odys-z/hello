...
//    private static final ParseContext EMPTY_PARSE_CONTEXT = new ParseContext();
    ...
    public void parseJpeg(File file) throws IOException, SAXException, JpegProcessingException, MetadataException {
            com.drew.metadata.Metadata jpegMetadata = JpegMetadataReader.readMetadata(file);
            handle(jpegMetadata);
    }

    public void parseTiff(File file) throws IOException, SAXException, TiffProcessingException, MetadataException {
            com.drew.metadata.Metadata tiffMetadata = TiffMetadataReader.readMetadata(file);
            handle(tiffMetadata);
    }

    public void parseWebP(File file) throws IOException, RiffProcessingException, MetadataException {
            com.drew.metadata.Metadata webPMetadata = new com.drew.metadata.Metadata();
            webPMetadata = WebpMetadataReader.readMetadata(file);
            handle(webPMetadata);
    }

    public void parseHeif(InputStream is) throws IOException, MetadataException  {
    ...
    public void parseRawExif(InputStream stream, int length, boolean needsExifHeader)
            throws IOException, SAXException, MetadataException  {
        byte[] exif;
        if (needsExifHeader) {
    ...
    public void parseRawExif(byte[] exifData) throws IOException, SAXException, MetadataException  {
...
//    public void parseRawXMP(byte[] xmpData) throws IOException, SAXException  {
