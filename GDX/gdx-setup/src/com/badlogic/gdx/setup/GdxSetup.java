...
public class GdxSetup {
	// odys-z
	public static final String gradle_distUrl = "https://services.gradle.org/distributions/gradle-5.4.1-bin.zip";
	...
	public void build (ProjectBuilder builder, String outputDir, String appName, String packageName, String mainClass,
			Language language, String sdkLocation, String gradleUrl, CharCallback callback, List<String> gradleArgs) {
		...
		project.files.add(new ProjectFile("gradle/wrapper/gradle-wrapper.properties", true));
		...
		// odys-z
		values.put("%Gradle.distributionUrl%", gradleUrl);
	...
	private static void printHelp () {
		// odys-z (--gradle-dist-url)
		System.out
			.println("Usage: GdxSetup --dir <dir-name> --name <app-name> --package <package> --mainClass <mainClass> --sdkLocation <SDKLocation> [--gradle-dist-url <gradle-bin.zip url>] [--excludeModules <modules>] [--extensions <extensions>]");
		...
		// odys-z
		System.out.println("gradle-dist-url ... the location of your gradle. use local file://path/zip for avoid download");
...
//	}
	...
	public static void main (String[] args) throws IOException {
		...
		if (!params.containsKey("dir") ||
			...
			// odys-z
			// TODO doc
			String gradleUrl = params.get("gradle-dist-url");
			if (gradleUrl == null || gradleUrl.trim().length() == 0)
				gradleUrl = gradle_distUrl;
			
			new GdxSetup().build(builder, params.get("dir"), params.get("name"), params.get("package"), params.get("mainClass"), languageEnum,
				sdkLocation, gradleUrl, new CharCallback() {
					@Override
