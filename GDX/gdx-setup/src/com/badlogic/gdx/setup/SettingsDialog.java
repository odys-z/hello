...
public class SettingsDialog extends JDialog {
	...
	private void uiLayout (final SetupCheckBox gwtCheckBox) {
		...
		// odys-z
		JLabel gradlelable = new JLabel("gradle-bin");
		gradlelable.setForeground(new Color(170, 170, 170));
		content.add(gradlelable,
				new GridBagConstraints(0, 7, 4, 1, 1, 1, NORTH, HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		gradleUrl = new JTextField(40);
		gradleUrl.setText(GdxSetup.gradle_distUrl);
		gradleUrl.setForeground(new Color(170, 170, 170));
		content.add(gradleUrl, new GridBagConstraints(1, 7, 6, 1, 1, 1, NORTH, HORIZONTAL, new Insets(0, 15, 0, 0), 0, 0));
		JLabel urlable = new JLabel("file\\:///path-to/gradle-x.y.z-bin.zip");
		urlable.setForeground(new Color(170, 170, 170));
		content.add(urlable,
				new GridBagConstraints(2, 8, 4, 1, 1, 1, NORTH, HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
	...
	private void uiStyle () {
		...
		// odys-z
		gradleUrl.setBorder(border);
		gradleUrl.setCaretColor(new Color(255, 255, 255));
		gradleUrl.setBackground(new Color(46, 46, 46));
		gradleUrl.setForeground(new Color(255, 255, 255));
	}
