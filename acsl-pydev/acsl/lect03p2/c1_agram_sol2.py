...
t = TestCase()
t.assertEqual('TD', agram2(['5D', '2D', '6H', 'KD', 'TD', '6S']))
t.assertEqual('9D', agram2(['5D', '2D', '6H', '9D', 'TD', '6S']))
t.assertEqual('KC', agram2(['TC', 'AC', 'KC', 'QH', 'JS', 'TD']))
t.assertEqual('2D', agram2(['3D', '4H', '5C', '6S', '2D', '7H']))
t.assertEqual('3H', agram2(['KS', 'TH', 'QC', '7H', '9H', '3H']))
t.assertEqual('AD', agram2(['AC', 'AD', 'KH', 'JS', 'KS', 'QS']))

t.assertEqual('7H', agram2(['6H', '2H', '4C', '7H', '9D', '6S']))
t.assertEqual('2S', agram2(['AC', '2S', '5D', '6H', 'JS', '3S']))
t.assertEqual('4D', agram2(['KD', '4S', '4C', '4S', '4D', 'KS']))
t.assertEqual('2C', agram2(['QS', '4D', '7C', '8D', 'TH', '2C']))
t.assertEqual('KC', agram2(['TC', 'KC', '5H', 'AD', '7C', 'TS']))
print('OK!')
